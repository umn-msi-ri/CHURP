...
cat("Number of read pairs (from subsample) and percentage of library \n",
	    "that is estimated to be derived from ribosomal RNA.\n")
bbduk_summary
...
names(hisat_tab) <- c(
    ...
    "Multiply Mapped",
    "Discordantly Mapped")
cat("Summary of alignment from HISAT2 based on \n",
    "fragment counts. Note that if the samples are \n",
    "paired-end, then each fragment is represented \n",
    "by 2 reads. If the samples are single-end, then \n",
    "each fragment is represented by 1 read\n")
hisat_tab
...
cat("Summary of alignment from HISAT2 based on \n",
    "percentage of total reads. Note that if the samples are \n",
    "paired-end, then each fragment is represented \n",
    "by 2 reads. If the samples are single-end, then \n",
    "each fragment is represented by 1 read\n")
